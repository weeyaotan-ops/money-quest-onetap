...
const context=vm.createContext({require:fakeRequire,Buffer,URL,AbortSignal,process:{env:{TELEGRAM_CHAT_ID:'test-chat',TELEGRAM_AUTH_USER_ID:'test-user',BINANCE_ONETAP_LIVE:'1'}},console:{log(){},warn(){},error(){}},setInterval:()=>({unref(){}}),setTimeout,fetch:()=>{throw Error('NETWORK_FORBIDDEN')},messages});
